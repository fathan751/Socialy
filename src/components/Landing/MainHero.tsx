  ...
  return (
    ...
    <section className="flex flex-col items-center gap-10 py-20 px-3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
            <Link to={"/register"} className="font-semibold px-10 py-3 text-xl text-white cursor-pointer hover:scale-105 hover:opacity-90 rounded-xl
            ...
            <Link to={"/login"} className="bg-white text-xl px-10 py-3 hover:text-white hover:bg-[#7F49DF] rounded-xl cursor-pointer transition-colors ease-out duration-500">I already have an account</Link>
        </div>
    </section>
  )
}
